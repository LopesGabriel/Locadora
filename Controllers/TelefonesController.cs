...
namespace Locadora.Controllers
{
    public class TelefonesController : Controller
    {
        ...
        public TelefonesController(LocadoraContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Numero,TipoTelefone")] Telefone telefone)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Numero,TipoTelefone")] Telefone telefone)
        {
            if (id != telefone.Id)
            {
                return NotFound();
